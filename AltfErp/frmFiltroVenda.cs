    ...
    public partial class frmFiltroVenda : Form
    {
        ...
        private void btnExecutar_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    RETORNO = "(((IT.QUANTIDADE * IT.VALOR - VD.DESCONTO) - ROUND(X.TOTAL_RECEBIMENTO, -1)) > 0 or ROUND(X.TOTAL_RECEBIMENTO, -1) is null)--";
                }
                else
                {
                    if (rbtnPagos.Checked == true)
                    {
                        RETORNO = "((IT.QUANTIDADE * IT.VALOR - VD.DESCONTO) - ROUND(X.TOTAL_RECEBIMENTO, -1)) = 0--";
                    }
                    else
                    {
